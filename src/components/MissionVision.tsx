    ...
    return (
        <section className="py-16 px-4 bg-white">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
                {/* Mission Card */}
                <div className="group p-8 rounded-2xl bg-white border border-n-100 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-2xl font-bold text-n-900 mb-4">Our Mission</h3>
                ...
                <div className="group p-8 rounded-2xl bg-white border border-n-100 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-2xl font-bold text-n-900 mb-4">Our Vision</h3>
                        <p className="text-n-600 leading-relaxed">
