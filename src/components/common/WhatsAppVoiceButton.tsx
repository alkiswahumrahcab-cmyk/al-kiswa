    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 translate-x-3 4xl:translate-x-0">
            ...
            <a
                ...
                className="group relative flex items-center justify-center w-16 h-16 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-all hover:scale-110 active:scale-95"
