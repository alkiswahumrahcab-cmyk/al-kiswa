...
const ziyaratFAQs = [
    ...
    { question: "What vehicles are available for Ziyarat tours?", answer: "Toyota Camry sedans (4 pax), GMC Yukon AT4 SUVs (7 pax), Hyundai Staria/H1 vans (7 pax), Toyota Hiace (10 pax), and Toyota Coaster buses (19 pax)." },
