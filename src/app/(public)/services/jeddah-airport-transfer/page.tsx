                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-6xl mx-auto">
                            {[
                                ...
                                <div key={idx} className="flex flex-col items-center text-center p-4 bg-white/5 rounded-xl border border-white/10 hover:border-gold/30 transition-colors">
                                    ...
                                    <p className="text-xs text-white/60 font-light">{feature.desc}</p>
                                </div>
                            ))}
                        </div>
                    </FadeIn>
                    ...
                    <FadeIn delay={0.2}>
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-10">
                                <h2 className="text-3xl md:text-4xl font-semibold text-white font-display mb-4">
                                ...
                                <p className="text-white/60 font-light text-lg">Fixed rates for your peace of mind. No hidden fees.</p>
                            </div>
                                ...
                                <table className="w-full text-sm md:text-base">
                                    <thead>
                                        <tr className="bg-gold/10 border-b border-gold/20">
                                            ...
                                            <th className="text-center p-5 text-white font-bold tracking-wider">Sedan<br/><span className="text-xs text-white/60 font-light">(1-4 Seats)</span></th>
                                            <th className="text-center p-5 text-white font-bold tracking-wider">GMC Yukon<br/><span className="text-xs text-white/60 font-light">(1-7 Seats)</span></th>
                                            <th className="text-center p-5 text-white font-bold tracking-wider">Hyundai Staria<br/><span className="text-xs text-white/60 font-light">(1-9 Seats)</span></th>
                                            <th className="text-center p-5 text-white font-bold tracking-wider">Toyota Hiace<br/><span className="text-xs text-white/60 font-light">(10-14 Seats)</span></th>
                                        </tr>
                                    </thead>
                ...
                <div className="container mx-auto px-4">
                    <FadeIn delay={0.3}>
                        <div className="max-w-4xl mx-auto prose prose-invert prose-gold">
                            <h2 className="text-3xl font-semibold font-display text-white mb-6">Your Trusted Umrah Taxi Service in Jeddah</h2>
                            ...
                            <h3 className="text-2xl font-semibold font-display text-white mb-4 mt-8 text-gold">How Our Private Airport Transfer in Saudi Arabia Works</h3>
                            ...
                            <h3 className="text-2xl font-semibold font-display text-white mb-4 mt-8 text-gold">Why Pilgrims Prefer Our Jeddah Airport to Madinah Transfer</h3>
                            <p className="text-white/80 leading-relaxed font-light mb-6">
                            ...
                            <h3 className="text-2xl font-semibold font-display text-white mb-4 mt-8 text-gold">Safety, Comfort, and 10+ Years of Reliability</h3>
                            <p className="text-white/80 leading-relaxed font-light mb-6">
