...
export const metadata: Metadata = {
    title: "تاكسي مطار جدة إلى المدينة المنورة | الكسوة",
    description: "احجز تاكسي موثوق من مطار جدة إلى فندقك في المدينة المنورة بالقرب من المسجد النبوي. استقبال ترحيبي، وأسعار ثابتة.",
    keywords: [
        "تاكسي مطار جدة",
        "مطار جدة إلى المدينة",
        "تاكسي من جدة للمدينة",
        "توصيل من مطار جدة إلى المدينة"
    ],
    alternates: {
    ...generateMetadataAlternates("/services/jeddah-madinah-transfer"),
    canonical: "https://kiswahumrahcab.com/ar/services/jeddah-madinah-transfer",
  },
    openGraph: {
        title: "تاكسي مطار جدة إلى المدينة المنورة | الكسوة",
        description: "احجز تاكسي موثوق من مطار جدة إلى فندقك في المدينة المنورة بالقرب من المسجد النبوي. استقبال ترحيبي، وأسعار ثابتة.",
        images: [{ url: '/images/routes/jeddah-airport-madinah.jpg', width: 1200, height: 630, alt: 'نقل من مطار جدة إلى المدينة' }]
    }
};
            ...
            <section className="relative pt-[220px] pb-20 md:pt-[260px] lg:pt-[280px] md:pb-32 overflow-hidden border-b border-border bg-charcoal">
                <div className="absolute inset-0 z-0">
                    <Image 
                        ...
                        alt="تاكسي كبار الشخصيات من مطار جدة إلى المدينة المنورة" 
                        fill
                        priority
                ...
                <div className="container relative z-10 flex-1 flex flex-col justify-center">
                    <div className="max-w-4xl">
                        ...
                        <p className="sr-only md:not-sr-only md:block font-body text-lg md:text-xl text-white/95 leading-relaxed md:mb-6 max-w-2xl font-light drop-shadow-md">
                            توصيل مباشر من جدة إلى المدينة المنورة. استرخِ في سياراتنا الفاخرة طوال الطريق.
                        </p>
