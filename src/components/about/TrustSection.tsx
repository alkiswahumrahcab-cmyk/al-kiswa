            ...
            <div className="container mx-auto px-4 relative z-10">
                <FadeIn>
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-black border border-gold/30 backdrop-blur-md mb-10 shadow-[0_0_20px_hsl(var(--gold-glow) / 0.1)]">
                        ...
                        <cite className="block text-sm font-bold tracking-[0.2em] text-gold uppercase not-italic">
