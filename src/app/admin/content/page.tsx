    ...
    return (
        <div className="p-6">
                ...
                <div className="p-4 border-b border-gray-200">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 bg-gray-50 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                        />
                    </div>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-12 text-gray-600">No sections found. Try seeding defaults.</div>
            ) : (
                    ...
                    {Object.entries(groupedSections).map(([page, pageSections]) => (
                        <div key={page} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                                <h2 className="text-lg font-semibold text-gray-900">{page} Page</h2>
                            </div>
