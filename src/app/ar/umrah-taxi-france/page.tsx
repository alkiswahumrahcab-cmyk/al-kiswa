    ...
    <main className="min-h-screen bg-charcoal text-white pt-24 pb-16 font-arabic" dir="rtl">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center mb-16">
          <span className="text-gold font-bold uppercase tracking-widest text-sm">🇫🇷 للحجاج الفرنسيين</span>
          <h1 className="text-4xl md:text-6xl font-bold mt-4 mb-6 leading-tight">
            مواصلات العمرة<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-amber-400">للحجاج الفرنسيين</span>
          </h1>
