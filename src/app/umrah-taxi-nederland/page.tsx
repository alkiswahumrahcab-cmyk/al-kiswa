...
export const metadata = {
  title: "Umrah Vervoer Nederland | Taxi Jeddah Mekka | Al Kiswah",
  description: "Privé Umrah-transfer voor Nederlandse pelgrims. Luchthaven Jeddah → Mekka → Medina. Vaste prijzen, professionele chauffeurs, 24/7 support. Nu boeken.",
  alternates: {
    ...generateMetadataAlternates("/umrah-taxi-nederland"),
  ...
  keywords: [
    ...
    "Umra transfer luchthaven Jeddah", "Umrah 2025 Nederland",
    "privé transfer Mekka Medina", "Al Kiswah Nederland pelgrims",
    "islamitische reis Saudi-Arabië vervoer", "Umrah taxi boeken"
  ],
  openGraph: {
    title: "Umrah Vervoer voor Nederlandse Pelgrims — Al Kiswah",
    description: "Vaste prijzen. Geverifieerde chauffeurs. Jeddah → Mekka → Medina. Boek uw privé transfer.",
...
const features = [
  ...
  "Nederlandse ondersteuning beschikbaar",
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            ...
            In dienst van pelgrims uit Amsterdam, Rotterdam, Den Haag en heel Nederland.
          </p>
        ...
        <div className="bg-white/5 rounded-2xl border border-white/10 p-8 mb-12">
          <h2 className="text-2xl font-bold mb-6 text-white">Populaire Routes</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { from: "Luchthaven Jeddah (KAIA)", to: "Hotels Mekka", price: "Vanaf €45" },
              { from: "Mekka", to: "Medina", price: "Vanaf €75" },
              { from: "Luchthaven Medina", to: "Hotels Medina", price: "Vanaf €25" },
              { from: "Jeddah", to: "Medina (direct)", price: "Vanaf €95" },
            ].map((route, i) => (
        ...
        <div className="text-center bg-gradient-to-r from-gold-primary/10 to-amber-500/10 rounded-2xl border border-gold-primary/30 p-10">
          ...
          <p className="text-gray-400 mb-6">Neem contact op via WhatsApp — antwoord binnen enkele minuten.</p>
