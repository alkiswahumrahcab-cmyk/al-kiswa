...
export const metadata: Metadata = {
    title: "Jeddah Airport to Madinah Transfer 2026 | Al Kiswah",
    description: "Book a reliable Jeddah Airport taxi to your Masjid Nabawi hotel. 24/7 VIP pickup, meet & greet, and fixed prices. Book your transfer online now.",
    keywords: [
        "jeddah to madinah taxi",
        "jeddah airport to madinah",
        "jeddah airport to hotel",
        "jeddah airport taxi",
        "taxi from jeddah airport to masjid nabawi",
        "vip taxi jeddah airport"
    ],
    alternates: generateMetadataAlternates("/services/jeddah-madinah-transfer"),
    openGraph: {
        title: "Jeddah Airport to Madinah Transfer 2026 | Al Kiswah",
        description: "Book a reliable Jeddah Airport taxi to your Masjid Nabawi hotel. 24/7 VIP pickup, meet & greet, and fixed prices.",
        images: [{ url: '/images/routes/jeddah-airport-madinah.jpg', width: 1200, height: 630, alt: 'Jeddah Airport Transfer to Hotel' }]
    }
};
...
export default async function JeddahMadinahPage() {
    const settings = await getSettings();
    const phoneNumber = settings.contact.phone;
    const whatsappLink = `https://wa.me/${phoneNumber.replace(/[^0-9]/g, '')}?text=I%20need%20transfer%20from%20Jeddah%20to%20Madinah`;

    return (
        <main className="bg-bg text-body flex flex-col min-h-screen">
            <ServiceSchema
                serviceName="Jeddah Airport to Madinah Transfer"
                serviceType="Airport Transfer"
                description="Private taxi from King Abdulaziz International Airport to your hotel in Madinah. Meet and greet, luggage assistance, real-time flight tracking included."
                pageUrl="https://kiswahumrahcab.com/services/jeddah-madinah-transfer"
                citiesServed={["Jeddah", "Madinah"]}
                ratingValue="4.9"
                ratingCount={245}
                priceFrom={400}
                priceTo={850}
                image="https://kiswahumrahcab.com/images/routes/jeddah-airport-madinah.jpg"
                breadcrumbs={[
                    { name: "Home", url: "https://kiswahumrahcab.com" },
                    { name: "Services", url: "https://kiswahumrahcab.com/services" },
                    { name: "Jeddah Airport to Madinah Transfer", url: "https://kiswahumrahcab.com/services/jeddah-madinah-transfer" }
                ]}
            ...
            <section className="relative pt-32 pb-32 md:pt-40 lg:pt-48 md:pb-48 overflow-hidden border-b border-border bg-charcoal">
                <div className="absolute inset-0 z-0">
                    <Image 
                        src="/images/routes/jeddah-airport-madinah.jpg" 
                        alt="Private VIP Taxi from Jeddah Airport to Madinah Hotel" 
                        fill
                        priority
                ...
                <div className="container relative z-10 flex-1 flex flex-col justify-center">
                    <div className="max-w-4xl">
                        ...
                        <p className="sr-only md:not-sr-only md:block font-body text-lg md:text-xl text-white/95 leading-relaxed md:mb-6 max-w-2xl font-light drop-shadow-md">
                            Direct transfer for those landing in Jeddah but starting their Umrah in Madinah. A comfortable ride in our VIP vehicles.
                        </p>
