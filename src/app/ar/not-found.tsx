...
export default function NotFoundArabic() {
    return (
        <div className="min-h-screen bg-charcoal flex items-center justify-center relative overflow-hidden font-arabic" dir="rtl">
            {/* Background Pattern */}
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                <FadeIn>
                    <div className="mb-8 relative inline-block">
                        <h1 className="text-[150px] md:text-[200px] font-bold text-transparent bg-clip-text bg-gradient-to-b from-gold to-neutral-900 leading-none select-none opacity-20 transform translate-y-4">
                            404
                        </h1>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
                        <Link href="/ar" className="group bg-neutral-900/50 hover:bg-neutral-900 border border-white/10 hover:border-gold/50 p-6 rounded-2xl transition-all duration-300">
                            <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform text-gold">
                                <Home size={24} />
                            </div>
                    ...
                    <Link
                        href="/ar/booking"
                        className="inline-flex items-center justify-center gap-3 bg-gold text-black hover:bg-white px-10 py-4 rounded-full font-bold uppercase tracking-wider transition-all shadow-lg hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:-translate-y-1"
                    >
