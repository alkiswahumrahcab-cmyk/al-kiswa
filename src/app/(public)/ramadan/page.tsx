...
const ramadanPackages = [
    ...
    },
    {
        ...
        features: [
            ...
            <span key="vip">VIP <strong><Link href="/fleet/gmc-yukon-xl" className="hover:text-gold transition-colors">GMC Yukon</Link></strong> / <strong><Link href="/fleet/hyundai-staria" className="hover:text-gold transition-colors">Staria</Link></strong> Options</span>
        ],
        highlight: true,
        icon: <Star size={32} />
    },
