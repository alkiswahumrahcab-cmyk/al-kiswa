...
const ramadanPackages = [
    ...
    },
    {
        ...
        features: [
            ...
            <span key="vip">VIP <strong><Link href="/fleet/gmc-yukon-xl" className="hover:text-gold transition-colors">GMC</Link></strong> / <strong><Link href="/fleet/hyundai-staria" className="hover:text-gold transition-colors">Staria</Link></strong> Options</span>
        ],
        highlight: true,
        icon: <Star size={32} />
    },
                    ...
                    <FadeIn>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-gold/50 transition-colors group">
                                ...
                                <p className="text-white/60">Once confirmed, your ride is locked. No cancellations, no last-minute "unavailable" excuses.</p>
                            </div>
                            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-gold/50 transition-colors group">
                                <div className="w-14 h-14 bg-gold/10 rounded-btn flex items-center justify-center text-gold mb-6 group-hover:bg-gold group-hover:text-black transition-all">
                                    <CheckCircle size={32} />
                                ...
                                <p className="text-white/60">No surge pricing when you book in advance. Bypassing the high <Link href="/pricing" className="text-gold hover:underline">on-spot taxi fares</Link>.</p>
                            </div>
                        </div>
                    </FadeIn>
                </div>
