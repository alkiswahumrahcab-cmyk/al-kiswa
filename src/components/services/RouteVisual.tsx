        ...
        <div className="py-8">
            <div className="relative flex flex-col md:flex-row justify-between items-center max-w-4xl mx-auto bg-neutral-900/50 p-6 md:p-10 rounded-2xl border border-white/10 backdrop-blur-md">
                ...
                <div className="flex flex-col items-center text-center z-10 mb-8 md:mb-0">
                    <div className="w-16 h-16 bg-black rounded-full border-4 border-gold flex items-center justify-center shadow-[0_0_20px_hsl(var(--gold-glow) / 0.3)] mb-4">
                        <MapPin className="text-gold" size={32} />
                    </div>
                    <h3 className="text-xl font-semibold font-display text-white">{from}</h3>
                    <p className="text-sm text-n-400">{fromLabel}</p>
                </div>

                {/* Mid Point: Distance/Time */}
                <div className="flex flex-col items-center z-10 bg-black px-6 py-2 rounded-full border border-gold/30 shadow-sm mb-8 md:mb-0">
                ...
                <div className="flex flex-col items-center text-center z-10">
                    ...
                    <h3 className="text-xl font-semibold font-display text-white">{to}</h3>
