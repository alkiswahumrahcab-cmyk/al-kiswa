    ...
    <main className="min-h-screen bg-charcoal text-white pt-24 pb-16">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center mb-14">
          <span className="text-gold font-bold uppercase tracking-widest text-sm">🇳🇱 Voor Nederlandse Pelgrims</span>
        ...
        <div className="bg-white/5 rounded-2xl border border-white/10 p-8 mb-12">
          ...
          <div className="text-n-300 text-sm space-y-4 leading-relaxed">
            ...
            <p>Voor gezinnen van 4–8 personen is de <Link href="/fleet/hyundai-staria" className="text-gold hover:underline">Hyundai Staria</Link> (11 zitplaatsen) onze populairste keuze. Koppels kiezen vaak voor de <Link href="/fleet/toyota-camry" className="text-gold hover:underline">Toyota Camry</Link>. Grotere groepen kiezen de <Link href="/fleet/toyota-hiace" className="text-gold hover:underline">Toyota Hiace</Link> minibus.</p>
            <h3 className="text-white font-semibold mt-5">Route Mekka–Medina: Praktische tips</h3>
            <p>De route Mekka–Medina is ca. 430 km (~4,5–5 uur rijden). Boek deze rit ruim van tevoren, zeker tijdens de Ramadan. Zie onze pagina <Link href="/services/makkah-madinah-taxi" className="text-gold hover:underline">Taxi Mekka–Medina</Link> voor alle details.</p>
          </div>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-gold/10 to-amber-500/10 rounded-2xl border border-gold/30 p-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/booking" className="bg-gold text-black font-bold px-8 py-4 rounded-btn hover:scale-105 transition-transform">Online Boeken</Link>
