                    ...
                    <aside className={styles.sidebar}>
                        ...
                        <GlassCard delay={0.7} className={`${styles.sidebarWidget} p-6`}>
                            ...
                            <ul className="space-y-3">
                                <li>
                                    <Link href="/services/makkah-madinah-taxi" className="flex items-center gap-2 text-n-700 hover:text-amber-600 transition-colors">
                                        <div className="w-2 h-2 rounded-full bg-amber-500" />
                                        <span className="text-sm font-medium">Makkah ⇄ Madinah Taxi</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/services/jeddah-airport-transfer" className="flex items-center gap-2 text-n-700 hover:text-amber-600 transition-colors">
                                        <div className="w-2 h-2 rounded-full bg-amber-500" />
                                        <span className="text-sm font-medium">Jeddah Airport Transfer</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/services/ziyarat-tours" className="flex items-center gap-2 text-n-700 hover:text-amber-600 transition-colors">
                                        <div className="w-2 h-2 rounded-full bg-amber-500" />
