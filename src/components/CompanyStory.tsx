            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-n-900">
                            From Vision to Service, <span className="text-blue-600">Guided by Faith</span>
                        </h2>
                        <p className="text-n-600 leading-relaxed">
                        ...
                        <div className="pt-4 border-l-4 border-blue-600 pl-4">
                            <p className="text-lg font-medium text-n-800 italic">
                    ...
                    <div className="relative h-96 bg-n-200 rounded-2xl overflow-hidden shadow-xl border border-white/20 backdrop-blur-sm">
                        {/* Placeholder for an image */}
                        <div className="absolute inset-0 flex items-center justify-center text-n-400">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md p-6">
                            <div className="flex justify-between text-center">
                                <div>
                                    ...
                                    <div className="text-xs text-n-500">Years Serving</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-bold text-blue-600">10k+</div>
                                    <div className="text-xs text-n-500">Happy Pilgrims</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-bold text-blue-600">100%</div>
                                    <div className="text-xs text-n-500">Reliability</div>
                                </div>
                            </div>
                        </div>
                    </div>
