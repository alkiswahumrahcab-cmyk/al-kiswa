        ...
        return (
            <div className="text-center py-12">
                <motion.div
                    ...
                    className="w-20 h-20 bg-gold/10 text-gold rounded-full flex items-center justify-center mx-auto mb-6 border border-gold/20"
                >
                ...
                <div className="flex flex-col gap-3 max-w-xs mx-auto">
                    <Link
                        href="/"
                        className="px-8 py-4 bg-gradient-to-r from-gold to-gold-dark text-black font-bold uppercase tracking-widest rounded-2xl hover:scale-105 transition-all shadow-lg shadow-gold/20 text-center"
                    >
                        Back to Home
                    </Link>
        ...
        <div className="space-y-6 pb-4">
            ...
            <div className="md:hidden">
                <button
                    ...
                    className="w-full flex items-center justify-between bg-gold/10 border border-gold/30 rounded-2xl px-4 py-3.5 transition-all"
                >
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-white font-bold text-sm">
                                {selectedList.length > 0
                                    ...
                                    : 'No vehicle selected'}
                                {grandTotal > 0 && <span className="ml-2 text-gold">· {formatPrice(grandTotal).formatted}</span>}
                            </p>
                        </div>
                    </div>
                    ...
                    {showSummary && (
                        ...
                        >
                            <div className="mt-2 bg-white rounded-2xl overflow-hidden shadow-xl">
                                {/* Summary header */}
                                <div className="bg-gold p-4 text-black">
                                ...
                                <div className="p-4 space-y-4 text-n-900">
                                    {/* Route */}
                                    <div className="flex gap-3">
                                        <div className="flex flex-col items-center pt-1">
                                            <div className="w-2.5 h-2.5 rounded-full bg-black" />
                                            <div className="w-px h-10 bg-n-300 border-l border-dashed border-n-400 my-1" />
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-5">
                    <div className="bg-white rounded-3xl overflow-hidden shadow-2xl">
                        <div className="bg-gold p-5 text-black relative overflow-hidden">
                        ...
                        <div className="p-6 space-y-6 text-n-900">
                            <div className="flex gap-4">
                                <div className="flex flex-col items-center">
                                    <div className="w-3 h-3 rounded-full bg-black" />
                                    <div className="w-0.5 h-12 bg-n-200 border-l border-dashed border-n-400 my-1" />
            ...
            <div className="md:hidden space-y-4">
                ...
                <div className="space-y-1.5">
                    <label className="text-xs font-bold text-gold uppercase tracking-widest ml-1">Notes (Optional)</label>
                    <textarea
                        placeholder="Flight number, special requests..."
                        value={data.notes}
                        onChange={(e) => updateData({ notes: e.target.value })}
            ...
            <div className="pt-2">
                ...
                <button
                    ...
                    className="w-full py-4 md:py-5 bg-gradient-to-r from-gold via-[#F3D383] to-gold text-black font-black uppercase tracking-widest rounded-2xl shadow-[0_0_30px_-5px_hsl(var(--gold-glow) / 0.5)] hover:shadow-[0_0_50px_hsl(var(--gold-glow) / 0.6)] hover:scale-[1.01] transition-all flex items-center justify-center gap-3 group disabled:opacity-50 disabled:cursor-not-allowed min-h-[56px] text-sm md:text-base"
                >
                    {isSubmitting ? (
