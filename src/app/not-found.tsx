...
import { Home, Car, Phone, ArrowRight, Search } from 'lucide-react';
...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-primary-black flex items-center justify-center relative overflow-hidden font-sans">
            ...
            {/* Glowing Effects */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gold-primary/5 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gold-primary/5 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                <FadeIn>
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                        Page Not Found
                        <span className="block text-xl font-normal text-gold-primary mt-2 font-arabic">الصفحة غير موجودة</span>
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
                        <Link href="/" className="group bg-neutral-900/50 hover:bg-neutral-900 border border-white/10 hover:border-gold-primary/50 p-6 rounded-2xl transition-all duration-300">
                        ...
                        <Link href="/fleet" className="group bg-neutral-900/50 hover:bg-neutral-900 border border-white/10 hover:border-gold-primary/50 p-6 rounded-2xl transition-all duration-300">
                            <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform text-gold-primary">
                                <Car size={24} />
                            </div>
                        ...
                        <Link href="/contact" className="group bg-neutral-900/50 hover:bg-neutral-900 border border-white/10 hover:border-gold-primary/50 p-6 rounded-2xl transition-all duration-300">
                            <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform text-gold-primary">
                                <Phone size={24} />
                            </div>
                    ...
                    <Link
                        href="/booking"
                        className="inline-flex items-center gap-3 bg-gold-primary text-black hover:bg-white px-10 py-4 rounded-full font-bold uppercase tracking-wider transition-all shadow-lg hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:-translate-y-1"
                    >
