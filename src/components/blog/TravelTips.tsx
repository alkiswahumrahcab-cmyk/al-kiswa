                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {tips.map((tip, index) => (
                        <FadeIn key={index} delay={index * 0.1} direction="up">
                            <GlassCard className="h-full flex flex-col p-0 overflow-hidden bg-neutral-900 border-white/10 hover:border-gold/30 group transition-all duration-500 hover:shadow-2xl">
                                <div className="relative h-64 bg-black flex items-center justify-center overflow-hidden">
                                    ...
                                    <div className="relative z-10 transform scale-150 group-hover:scale-125 transition-transform duration-700 text-gold/20">
                                        <tip.icon size={80} />
                                    </div>
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black to-transparent flex items-end justify-between">
                                        <div className="w-12 h-12 rounded-full bg-gold text-black flex items-center justify-center font-bold font-sans text-xl shadow-lg shadow-gold/20 translate-y-6 group-hover:translate-y-0 transition-transform duration-300">
                                            0{index + 1}
                                        </div>
                                        <div className="text-gold opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">
                                            <tip.icon size={32} />
                                        </div>
                                    </div>
                                </div>
