        ...
        <div className="relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative pb-24 md:pb-0">
                ...
                <div className="lg:col-span-8 space-y-6">
                    <div className="flex justify-between items-center text-gray-400 text-sm border-b border-white/10 pb-2 mb-4">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <button 
                                            ...
                                            className="w-full py-2 bg-white/5 hover:bg-white/10 border-t border-white/10 flex items-center justify-center gap-2 text-xs font-semibold text-gray-300 uppercase tracking-wider transition-colors focus:outline-none"
                                        >
                                            {isExpanded ? (
                                        ...
                                        <div key={p.vehicleId} className="flex justify-between items-center p-4 rounded-xl bg-white/5 border border-white/10">
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-400 mt-1 flex gap-2">
                                                    ...
                                                    <span className="flex items-center gap-1"><Luggage size={12} className="text-gray-500" /> {display.bags}</span>
                                                </div>
                                            </div>
