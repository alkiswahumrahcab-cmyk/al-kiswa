...
export const FLEET: readonly Vehicle[] = Object.freeze([
  {
    ...
    image: { hero: '/images/fleet/camry-hero.jpg', card: '/images/fleet/camry-card.jpg', alt: 'Toyota Camry' },
    bookable: true,
    hasDetailPage: true,
  },
  {
    ...
    image: { hero: '/images/fleet/xpander-hero.jpg', card: '/images/fleet/xpander-card.jpg', alt: 'Mitsubishi Xpander' },
    bookable: true,
    hasDetailPage: false,
  },
  {
    ...
    image: { hero: '/images/fleet/yukon-hero.jpg', card: '/images/fleet/yukon-card.jpg', alt: 'GMC Yukon XL' },
    bookable: true,
    hasDetailPage: false, 
  },
  {
    ...
    image: { hero: '/images/fleet/staria-hero.jpg', card: '/images/fleet/staria-card.jpg', alt: 'Hyundai Staria' },
    bookable: true,
    hasDetailPage: true,
  },
  {
    ...
    image: { hero: '/images/fleet/starex-hero.jpg', card: '/images/fleet/starex-card.jpg', alt: 'Hyundai H1 Starex' },
    bookable: true,
    hasDetailPage: true,
  },
  {
    ...
    image: { hero: '/images/fleet/hiace-hero.jpg', card: '/images/fleet/hiace-card.jpg', alt: 'Toyota Hiace' },
    bookable: true,
    hasDetailPage: true,
  },
  {
    ...
    image: { hero: '/images/fleet/coaster-hero.jpg', card: '/images/fleet/coaster-card.jpg', alt: 'Toyota Coaster' },
    bookable: true,
    hasDetailPage: true,
  }
]);
