    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -5 }}
          className="absolute left-0 right-0 z-50 bg-[#0B0F19]/95 backdrop-blur-2xl border border-white/10 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden mt-2"
          style={{ top: '100%' }}
        >
          {children}
        </motion.div>
