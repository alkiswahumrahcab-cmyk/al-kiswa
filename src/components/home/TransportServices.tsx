                ...
                <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
                    {services.map((service, index) => (
                        <FadeIn key={service.id} delay={index * 0.15}>
                            <article className="group h-full relative border border-white/10 hover:border-gold/50 rounded-[2.5rem] transition-all duration-500 hover:shadow-[0_20px_40px_-15px_hsl(var(--gold-glow) / 0.15)] hover:-translate-y-2 bg-white/5 backdrop-blur-sm overflow-hidden flex flex-col">
                                <Link href={service.link} className="relative h-72 md:h-80 overflow-hidden block">
                                    ...
                                    />
                                    <div className="absolute top-6 left-6 z-20 w-14 h-14 rounded-2xl bg-black/40 backdrop-blur-md border border-white/20 flex items-center justify-center text-white shadow-xl group-hover:bg-gold group-hover:border-gold group-hover:text-black transition-all duration-300 group-hover:scale-110">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
                                        ...
                                        <h3 className="text-3xl font-bold font-sans text-white leading-tight group-hover:text-gold transition-colors duration-300">
                                            {service.title}
                                        </h3>
                                    </div>
                                </Link>
