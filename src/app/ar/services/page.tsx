    ...
    const serviceFAQs = [
        {
            ...
            answer: <span>Booking is simple. You can reserve your <Link href="/ar/services/jeddah-airport-transfer" className="text-gold-primary hover:text-white transition-colors hover:underline">Jeddah Airport to Makkah taxi</Link> online in advance. We monitor your flight arrival and our driver meets you at the terminal with a name sign.</span>
        },
        {
            question: "What is the best transport for Umrah families?",
            answer: <span>For families, we highly recommend our <Link href="/ar/fleet/gmc-yukon-at4" className="text-gold-primary hover:text-white transition-colors hover:underline">GMC Yukon XL</Link> or <Link href="/ar/fleet/hyundai-staria" className="text-gold-primary hover:text-white transition-colors hover:underline">Hyundai Staria</Link>. These spacious vehicles offer ample luggage space and AC comfort for the 1-hour journey to Makkah.</span>
        },
        {
        ...
        },
        {
            ...
            answer: <span>Our prices are fixed and transparent. You will know the exact cost of your <Link href="/ar/booking" className="text-gold-primary hover:text-white transition-colors hover:underline">Umrah transport booking</Link> upfront, with no hidden fees or toll charges.</span>
        },
        {
            question: "Do you provide Ziyarat tours in Makkah and Madinah?",
            answer: <span>Yes, we offer comprehensive <Link href="/ar/services/ziyarat-tours" className="text-gold-primary hover:text-white transition-colors hover:underline">Ziyarat packages</Link>. Visit historical sites like Jabal Al-Nour, Masjid Quba, and Mount Uhud in the comfort of a private vehicle with a knowledgeable driver.</span>
        }
    ];
