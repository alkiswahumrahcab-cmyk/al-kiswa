        ...
        <div className="min-h-screen bg-charcoal text-white font-sans selection:bg-gold-primary/30">
            ...
            <header className="w-full bg-[#111111] border-b border-white/10 py-6 px-4 text-center">
                <Link href="/">
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-sm text-n-400 mt-2">Scan result for booking #{shortId}</p>
                    </div>
                </Link>
            </header>
                ...
                <div className="flex justify-center mb-10">
                    {isVerified ? (
                        <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-6 flex flex-col items-center justify-center w-full max-w-sm shadow-[0_0_30px_rgba(34,197,94,0.1)]">
                            ...
                            <p className="text-n-400 text-sm mt-3 text-center">This is a valid, official booking receipt.</p>
                        </div>
                    ) : (
                        <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-6 flex flex-col items-center justify-center w-full max-w-sm shadow-[0_0_30px_rgba(239,68,68,0.1)]">
                            ...
                            <p className="text-n-400 text-sm mt-3 text-center">We could not find a booking matching this ID.</p>
                        </div>
                    )}
                </div>
                    ...
                    <>
                                ...
                                <div className="p-6 md:p-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-4 mt-4 border-t border-white/10 flex justify-between items-center">
                                            <span className="text-n-400 text-sm font-bold uppercase tracking-wider">Total Fare</span>
                                ...
                                <div className="p-6 md:p-8 bg-white/[0.02]">
                                    ...
                                    <div className="space-y-4" dir="rtl">
                                        ...
                                        <div className="pt-4 mt-4 border-t border-white/10 flex justify-between items-center flex-row-reverse">
                                            <span className="text-n-400 text-sm font-bold">إجمالي الأجرة</span>
                        ...
                        <div className="flex flex-col gap-4 mb-12">
                            <div className="text-center p-4 bg-white/5 border border-gold-primary/20 rounded-xl">
                                ...
                                <p className="text-n-300 text-sm">A PDF receipt has been sent to the customer's email.</p>
                            ...
                            <div className="flex justify-center mt-2">
                                <Link 
                                    href="/"
                                    className="inline-flex items-center justify-center gap-2 bg-transparent hover:bg-white/5 text-n-300 font-semibold py-4 px-8 rounded-xl border border-white/10 transition-colors"
                                >
                                    <PlusCircle size={20} />
                                    Book Another Ride
                                </Link>
            ...
            <footer className="bg-[#0a0a0a] border-t border-white/5 py-10 px-4 text-center">
                <div className="max-w-2xl mx-auto space-y-6">
                    <div>
                        <p className="text-n-400 text-sm leading-relaxed">Thank you for choosing Al Kiswah Umrah Cab.</p>
                        <p className="text-n-400 text-sm leading-relaxed">We wish you a blessed and safe Umrah journey.</p>
                    </div>
                    
                    <div className="w-16 h-[1px] bg-white/10 mx-auto"></div>
                    
                    <div>
                        <p className="text-n-400 text-[15px] leading-relaxed font-bold" dir="rtl">شكرًا لاختياركم شركة الكسوة لسيارات العمرة.</p>
                        <p className="text-n-400 text-[15px] leading-relaxed font-bold" dir="rtl">نتمنى لكم رحلة عمرة مباركة وآمنة.</p>
                    </div>
                </div>
            </footer>
        </div>
...
function DetailRow({ label, value }: { label: string, value: string }) {
    return (
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline border-b border-white/5 pb-2 last:border-0 last:pb-0 gap-1 sm:gap-4">
            <span className="text-xs text-n-500 uppercase tracking-wider font-semibold whitespace-nowrap">{label}</span>
            <span className="text-sm font-medium text-n-200 text-left sm:text-right break-words">{value || '—'}</span>
        </div>
    );
}
...
function DetailRowAr({ label, value }: { label: string, value: string }) {
    return (
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline border-b border-white/5 pb-2 last:border-0 last:pb-0 gap-1 sm:gap-4">
            <span className="text-xs text-n-500 font-bold whitespace-nowrap">{label}</span>
            <span className="text-sm font-medium text-n-200 text-right sm:text-left break-words" dir="auto">{value || '—'}</span>
        </div>
    );
}
