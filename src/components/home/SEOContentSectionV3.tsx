                    ...
                    <div className="max-w-4xl mx-auto space-y-10">
                        ...
                        <div className="prose prose-invert max-w-none text-center md:text-left space-y-8">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-n-400 leading-relaxed mb-4">
                            ...
                            <div>
                                ...
                                <div className="text-lg text-n-400 leading-relaxed mb-4">
                                ...
                                <ul className="list-disc list-inside text-n-400 space-y-2 ml-4 mb-4">
                                    <li>
                                        <strong>GMC Yukon / Chevrolet Tahoe:</strong> The epitome of luxury and power. Perfect for families of up to 7 passengers looking for a VIP experience. Book your <Link href="/fleet/gmc-yukon-at4" className="text-white hover:text-gold transition-colors">GMC Yukon XL</Link> for maximum luggage space and comfort.
                                    </li>
                                    <li>
                                        <strong>Hyundai Staria / H1:</strong> A versatile and spacious MPV, ideal for families or small groups (7-9 passengers). It offers excellent visibility, modern interiors, and a smooth ride. Explore our <Link href="/fleet/hyundai-staria" className="text-white hover:text-gold transition-colors">Hyundai Staria fleet</Link>.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <strong>Luxury Sedans:</strong> For business travelers or solo pilgrims, offering a premium yet economical <Link href="/services" className="text-white hover:text-gold transition-colors">private car service</Link>.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-lg text-n-400 leading-relaxed mb-4">
                                    No Umrah trip is complete without visiting the historical sites that bear witness to the history of Islam. We offer comprehensive <strong><Link href="/services/ziarah-makkah" className="text-gold hover:text-white transition-colors underline decoration-gold/30 underline-offset-4">Ziarah services in Makkah</Link></strong>, taking you to sacred landmarks such as Jabal Al-Noor (Cave of Hira), Jannat al-Mualla, and the sites of Hajj (Mina, Arafat, Muzdalifah).
                                </p>
                                <p className="text-lg text-n-400 leading-relaxed mb-4">
                                    Similarly, our <strong><Link href="/services/ziarah-madinah" className="text-gold hover:text-white transition-colors underline decoration-gold/30 underline-offset-4">Madinah Ziarah packages</Link></strong> cover Masjid Quba, Mount Uhud, Masjid Qiblatayn, and the Seven Mosques. Our knowledgeable drivers often share local insights and ensure you have ample time to pray and reflect at each location. These tours are fully customizable—you can choose which sites to visit and how long to stay.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <ol className="list-decimal list-inside text-n-400 space-y-2 ml-4 mb-4">
                                    ...
                                    <li><strong>Fixed Pricing:</strong> The price you see is the price you pay. We have a strict <Link href="/pricing" className="text-white hover:text-gold transition-colors">no-hidden-fee policy</Link>, covering fuel, tolls, and parking.</li>
                                ...
                                <p className="text-lg text-n-400 leading-relaxed">
                            ...
                            <div>
                                ...
                                <div className="text-lg text-n-400 leading-relaxed mb-6">
                                    <ul className="list-disc list-inside text-n-400 space-y-2 ml-4">
                                ...
                                <div className="space-y-3">
                                    {seoFaqs.map((faq, index) => (
                                        <div key={index} className="border border-white/5 rounded-lg overflow-hidden bg-black/20">
                                            ...
                                            >
                                                <h5 className={`font-semibold transition-colors ${activeFaq === index ? 'text-gold' : 'text-white'}`}>
                                                    {faq.question}
                                                </h5>
                                                <ChevronDown 
                                                    size={18} 
                                                    className={`text-n-400 transition-transform duration-300 shrink-0 ml-4 ${activeFaq === index ? 'rotate-180 text-gold' : ''}`} 
                                                />
                                            </button>
                                            <div 
                                                className={`transition-all duration-300 ease-in-out overflow-hidden ${activeFaq === index ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}
                                            >
                                                <div className="p-4 pt-0 text-sm text-n-400 border-t border-white/5 mt-3 pt-3">
                                                    {faq.answer}
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="prose prose-invert max-w-none text-center md:text-right space-y-6" dir="rtl">
                            ...
                            <p className="text-lg text-n-400 leading-relaxed font-amiri">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 pt-8 border-t border-white/10">
                            <div>
                                ...
                                <ul className="space-y-2 text-n-400">
                            ...
                            <div dir="rtl" className="text-right">
                                ...
                                <ul className="space-y-2 text-n-400 font-amiri">
