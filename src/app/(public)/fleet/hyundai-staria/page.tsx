...
export default async function HyundaiStariaPage() {
    ...
    return (
        <main className="overflow-x-hidden bg-charcoal dark:bg-deep-black font-sans">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <StariaAnimations key={idx} type="slide-up" delay={idx * 0.1}>
                                <div className="bg-white dark:bg-charcoal p-8 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800 hover:-translate-y-2 transition-transform duration-300">
            ...
            <section className="py-24 bg-white dark:bg-charcoal border-y border-slate-100 dark:border-slate-800">
                <div className="container mx-auto px-4">
            ...
            <section className="py-24 bg-charcoal dark:bg-deep-black">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white dark:bg-charcoal p-4 rounded-2xl shadow border border-slate-100 dark:border-slate-800">
