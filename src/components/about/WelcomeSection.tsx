            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center max-w-4xl mx-auto mb-16">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6 font-playfair leading-tight">
                        ...
                        <span className="block text-2xl md:text-4xl mt-3 font-reem-kufi text-emerald-700">الكسوة لنقل المعتمرين</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-gold/5 dark:bg-gold/10 border-l-4 border-gold p-6 rounded-r-xl">
                            <p className="text-xl font-medium text-emerald-950 dark:text-emerald-50 italic mb-2">
                                &quot;Serving the Guests of Allah with comfort and care is our mission.&quot;
                            </p>
                            <p className="text-lg font-arabic text-emerald-800 dark:text-emerald-200" dir="rtl">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800">
                            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 font-playfair flex justify-between items-center">
                                Why Choose Us?
                                <span className="font-reem-kufi text-xl text-gold">لماذا نحن؟</span>
                            </h3>
                        ...
                        {/* Spiritual Quote */}
                        <div className="bg-emerald-950 text-white p-8 rounded-3xl relative overflow-hidden ring-1 ring-gold/20">
                            ...
                            <cite className="block text-gold font-medium not-italic text-sm">– Qur’an (22:27) | سورة الحج</cite>

                            <p className="mt-6 pt-6 border-t border-white/10 text-slate-300 text-sm leading-relaxed">
                                {parseMarkdown("At Al Kiswah Umrah Transport, we believe that every journey to the holy cities should be filled with peace, comfort, and trust. That’s why we are committed to being the **leading Umrah transport company in Saudi Arabia**.")}
                            </p>
                        </div>
                    </div>
