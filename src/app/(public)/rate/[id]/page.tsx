                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 rounded-lg border border-n-200 focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none min-h-[100px] resize-none"
                    ...
                    <button
                        ...
                        className="w-full py-3 bg-n-900 text-white rounded-xl font-bold hover:bg-n-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
