            ...
            <div className="container mx-auto px-4 h-20 flex items-center justify-between">
                ...
                <div>
                    ...
                    <a
                        ...
                        className="hidden md:flex items-center gap-2 bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#25D366] border border-[#25D366]/30 px-4 py-2 rounded-btn text-sm font-bold transition-colors"
                    >
