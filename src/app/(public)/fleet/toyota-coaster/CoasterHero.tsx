...
export default function CoasterHero({ whatsappLink, phoneNumber }: Props) {
    return (
        <section className="relative h-[90vh] min-h-[560px] flex items-center justify-center overflow-hidden">
            ...
            >
                <Image
                    ...
                    alt="Toyota Coaster Group Umrah Transport"
                    fill
            ...
            <div className="relative z-10 container mx-auto px-6 text-center">
                ...
                >
                    The Master of <span className="text-gold">Saudi Roads</span>
                </motion.h1>
                ...
                >
                    The Toyota Coaster offers spacious, reliable, and comfortable group transport across Saudi Arabia, perfect for large families and Umrah groups.
                </motion.p>
