                ...
                <FadeIn>
                    <div className="bg-surface rounded-3xl shadow-lg p-8 md:p-12 max-w-4xl mx-auto border border-border backdrop-blur-md">
                        <div className="mb-8 pb-8 border-b border-border">
                            <h1 className="text-3xl font-semibold font-display text-ink mb-2">Privacy Policy</h1>
                        ...
                        <div className="space-y-8 text-ink leading-relaxed font-light">
                            ...
                            <section>
                                <h2 className="text-xl font-semibold text-ink mb-4 font-display">2. Information We Collect</h2>
                                <p className="mb-4">
                                    We may collect, use, store and transfer different kinds of personal data about you which we have grouped together follows:
                                </p>
                                <ul className="list-disc pl-5 space-y-2 marker:text-gold">
                                    <li><strong className="text-ink">Identity Data:</strong> includes first name, last name, username or similar identifier.</li>
                                    <li><strong className="text-ink">Contact Data:</strong> includes email address and telephone numbers.</li>
                                    <li><strong className="text-ink">Transaction Data:</strong> includes details about payments to and from you and other details of products and services you have purchased from us.</li>
                                    <li><strong className="text-ink">Technical Data:</strong> includes internet protocol (IP) address, your login data, browser type and version, time zone setting and location, browser plug-in types and versions, operating system and platform and other technology on the devices you use to access this website.</li>
                                </ul>
                            </section>

                            <section>
                                <h2 className="text-xl font-semibold text-ink mb-4 font-display">3. How We Use Your Information</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-xl font-semibold text-ink mb-4 font-display">4. Data Security</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-xl font-semibold text-ink mb-4 font-display">5. Contact Us</h2>
                                <p className="mb-6">
