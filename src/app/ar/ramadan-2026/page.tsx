                ...
                <div className="container mx-auto px-4">
                    <FadeIn>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-n-400 max-w-2xl mx-auto">Ramadan in Makkah is busy. Choose a transport partner that <Link href="/ar/booking" className="text-gold hover:underline">guarantees your arrival</Link>.</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-gold/50 transition-colors group">
                                ...
                                <p className="text-n-400">No surge pricing when you book in advance. Bypassing the high <Link href="/ar/pricing" className="text-gold hover:underline">on-spot taxi fares</Link>.</p>
                            </div>
                        </div>
                    </FadeIn>
                </div>
