                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-[1fr_auto_auto] md:grid-cols-[1.5fr_1fr_1fr] gap-3 mb-4 px-4">
                            ...
                            <div className="text-center">
                                <div className="inline-flex items-center gap-2 bg-gold/10 border border-gold/40 text-gold font-bold px-4 py-2 rounded-full text-sm">
                                    <ShieldCheck size={16} />
                                    Al Kiswah
                                </div>
                            </div>
                        ...
                        {/* Bottom CTA */}
                        <div className="mt-10 flex flex-col md:flex-row items-center justify-between gap-6 bg-gradient-to-r from-gold/10 to-transparent border border-gold/20 rounded-2xl px-6 py-5">
                            <div className="flex items-center gap-4">
                                <div className="p-3 bg-gold/15 rounded-xl text-gold shrink-0">
                                    <ShieldCheck size={28} />
                                </div>
                                <div>
                            ...
                            <a
                                href="/booking"
                                className="shrink-0 bg-gold text-black font-bold px-8 py-3 rounded-xl hover:bg-white transition-colors uppercase tracking-wider text-sm"
                            >
