...
export default function Receipt({ bookingData, onClose }: ReceiptProps) {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto bg-white text-n-900 rounded-2xl shadow-2xl overflow-hidden relative" id="receipt-container">
            {/* Header / Brand */}
            <div className="bg-surface-alt p-6 flex items-center justify-between border-b-4 border-gold">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-ink">Al Kiswah Transport</h2>
                ...
                <div className="text-right text-ink">
                    ...
                    <p className="text-xs font-medium text-muted">Booking Confirmed</p>
                </div>
            </div>
            ...
            <div className="p-8">
                <div className="flex justify-between items-end border-b border-n-200 pb-6 mb-6">
                    <div>
                        <p className="text-sm text-muted uppercase tracking-wide font-medium">Receipt No.</p>
                        <p className="text-lg font-bold text-n-900">{bookingData.id}</p>
                    </div>
                    <div className="text-right">
                        <p className="text-sm text-muted uppercase tracking-wide font-medium">Date</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-muted">{bookingData.email}</p>
                            <p className="text-sm text-muted">{bookingData.phone}</p>
                            <p className="text-sm text-muted mt-2 bg-n-50 inline-block px-2 py-1 rounded">
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    <p className="text-xs text-muted font-medium">Pickup Date</p>
                ...
                <div className="bg-n-50 rounded-xl p-4 mb-8 border border-n-100">
                    <div className="relative pl-6 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-n-300">
                        <div className="relative mb-4">
                            ...
                            <p className="text-xs text-muted font-medium">Pickup Location</p>
                            <p className="text-sm font-semibold text-n-900">{bookingData.pickupLocation}</p>
                        </div>
                        <div className="relative">
                            <div className="absolute -left-6 top-1 w-2.5 h-2.5 rounded-full bg-surface-alt border-2 border-white shadow-sm" />
                            <p className="text-xs text-muted font-medium">Dropoff Location</p>
                ...
                <div className="bg-n-50 rounded-xl p-6 mb-8 border border-n-100">
                    <h3 className="text-sm text-muted uppercase tracking-wider font-bold mb-4">Payment Summary</h3>
                ...
                <div className="text-center space-y-3">
                    ...
                    <p className="text-xs text-muted">Thank you for choosing Al Kiswah Umrah Transport. For support, contact us via WhatsApp at +966 54 870 7332</p>
                </div>
            </div>
            ...
            <div className="p-6 bg-n-50 border-t border-n-200 flex flex-col sm:flex-row items-center justify-center gap-4 print:hidden">
                <button 
                    onClick={handlePrint}
                    className="flex-1 w-full sm:w-auto flex items-center justify-center gap-2 bg-n-900 hover:bg-black text-ink px-6 py-3 rounded-xl font-medium transition-colors"
                >
