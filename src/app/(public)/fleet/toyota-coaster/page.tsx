                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <div className="mt-10">
                                <Link href="/booking" className="inline-flex items-center gap-2 bg-neutral-900 text-white hover:bg-n-800 dark:bg-white dark:text-n-900 px-8 py-3 rounded-full font-bold transition-all shadow-lg hover:shadow-gold/20">
