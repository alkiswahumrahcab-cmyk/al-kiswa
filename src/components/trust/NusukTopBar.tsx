    ...
    return (
        <div className="bg-[#0f3d2b] border-b border-[#1b5e43] text-white py-2 px-4 relative z-50">
            <div className="container mx-auto flex items-center justify-center gap-3 text-center">
                <ShieldCheck size={16} className="text-[hsl(var(--gold-light))] shrink-0" />
                <p className="text-xs md:text-sm font-medium tracking-wide">
                    <span className="hidden md:inline">All vehicles are officially registered on the </span>
                    <strong className="text-[hsl(var(--gold-light))] font-bold">Nusuk platform</strong> 
                ...
                <p className="hidden lg:block text-xs text-[hsl(var(--gold-light))]/80 font-arabic ml-4 pl-4 border-l border-white/10" dir="rtl">
