        ...
        <div className="min-h-screen bg-charcoal flex items-center justify-center relative overflow-hidden font-arabic" dir="rtl">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                <FadeIn>
                    ...
                    <Link
                        href="/ar/booking"
                        className="inline-flex items-center justify-center gap-3 bg-gold text-black hover:bg-white px-10 py-4 rounded-btn font-bold uppercase tracking-wider transition-all shadow-lg hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:-translate-y-1"
                    >
