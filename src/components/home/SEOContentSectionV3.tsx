            ...
            <div className="container relative z-10 px-4 md:px-6">
                <FadeIn>
                    <div className="max-w-4xl mx-auto space-y-10">
                        ...
                        <div className="prose dark:prose-invert max-w-none text-center md:text-left space-y-8">
                            {/* Introduction */}
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold font-playfair mb-6 text-foreground text-center md:text-left">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-foreground/70 leading-relaxed mb-4">
                                    After completing your Umrah rituals in Makkah, the next leg of your spiritual voyage is often a visit to the Prophet’s City, Madinah Munawwarah. Our <strong><Link href="/services/makkah-madinah-taxi" className="text-gold hover:text-foreground transition-colors underline decoration-gold/30 underline-offset-4">Makkah to Madinah taxi service</Link></strong> offers a smooth, safe, and scenic drive spanning approximately 450 kilometers. Early booking is highly recommended for peak travel periods, such as <Link href="/ramadan-2026" className="text-gold hover:text-foreground transition-colors underline decoration-gold/30 underline-offset-4">Ramadan 2026</Link>.
                                </p>
                                <p className="text-lg text-foreground/70 leading-relaxed mb-4">
                            ...
                            <div>
                                ...
                                <div className="text-lg text-foreground/70 leading-relaxed mb-4">
                                ...
                                <ul className="list-disc list-inside text-foreground/70 space-y-2 ml-4 mb-4">
                                    <li>
                                        <strong>GMC Yukon / Chevrolet Tahoe:</strong> The epitome of luxury and power. Perfect for families of up to 7 passengers looking for a VIP experience. Book your <Link href="/fleet/gmc-yukon-at4" className="text-foreground hover:text-gold transition-colors">GMC Yukon XL</Link> for maximum luggage space and comfort.
                                    </li>
                                    <li>
                                        <strong>Hyundai Staria / H1:</strong> A versatile and spacious MPV, ideal for families or small groups (7-9 passengers). It offers excellent visibility, modern interiors, and a smooth ride. Explore our <Link href="/fleet/hyundai-staria" className="text-foreground hover:text-gold transition-colors">Hyundai Staria fleet</Link>.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <strong>Luxury Sedans:</strong> For business travelers or solo pilgrims, offering a premium yet economical <Link href="/services" className="text-foreground hover:text-gold transition-colors">private car service</Link>.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-lg text-foreground/70 leading-relaxed mb-4">
                                    No Umrah trip is complete without visiting the historical sites that bear witness to the history of Islam. We offer comprehensive <strong><Link href="/services/ziarah-makkah" className="text-gold hover:text-foreground transition-colors underline decoration-gold/30 underline-offset-4">Ziarah services in Makkah</Link></strong>, taking you to sacred landmarks such as Jabal Al-Noor (Cave of Hira), Jannat al-Mualla, and the sites of Hajj (Mina, Arafat, Muzdalifah).
                                </p>
                                <p className="text-lg text-foreground/70 leading-relaxed mb-4">
                                    Similarly, our <strong><Link href="/services/ziarah-madinah" className="text-gold hover:text-foreground transition-colors underline decoration-gold/30 underline-offset-4">Madinah Ziarah packages</Link></strong> cover Masjid Quba, Mount Uhud, Masjid Qiblatayn, and the Seven Mosques. Our knowledgeable drivers often share local insights and ensure you have ample time to pray and reflect at each location. These tours are fully customizable—you can choose which sites to visit and how long to stay.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <ol className="list-decimal list-inside text-foreground/70 space-y-2 ml-4 mb-4">
                                    <li><strong>We Own Our Fleet (No Middleman):</strong> Unlike many booking platforms that act as aggregators, we own and operate our entire vehicle fleet. By booking directly with us, you bypass the middleman broker fees, ensuring you receive genuine wholesale <Link href="/fleet" className="text-foreground hover:text-gold transition-colors">Umrah taxi rates</Link> and direct accountability for your journey.</li>
                                    <li><strong>Official & Insured:</strong> We are a legally registered transport entity in Saudi Arabia, complying with all <a href="https://www.haj.gov.sa/" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline">Ministry of Hajj and Umrah</a> regulations.</li>
                                    <li><strong>Fixed Pricing:</strong> The price you see is the price you pay. We have a strict <Link href="/pricing" className="text-foreground hover:text-gold transition-colors">no-hidden-fee policy</Link>, covering fuel, tolls, and parking.</li>
                            ...
                            <div>
                                ...
                                <div className="text-lg text-foreground/70 leading-relaxed mb-6">
                            ...
                            <div className="bg-muted p-6 rounded-lg border border-border my-8">
                                <h4 className="text-xl font-bold text-gold mb-4">Frequently Asked Questions about Umrah Transport</h4>
                                <div className="space-y-3">
                                    {seoFaqs.map((faq, index) => (
                                        <div key={index} className="border border-border rounded-lg overflow-hidden bg-card">
                                            ...
                                            >
                                                <h5 className={`font-semibold transition-colors ${activeFaq === index ? 'text-gold' : 'text-foreground'}`}>
                                                    {faq.question}
                                                </h5>
                                                <ChevronDown 
                                                    size={18} 
                                                    className={`text-muted-foreground transition-transform duration-300 shrink-0 ml-4 ${activeFaq === index ? 'rotate-180 text-gold' : ''}`} 
                                                />
                                            </button>
                                            <div 
                                                className={`transition-all duration-300 ease-in-out overflow-hidden ${activeFaq === index ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}
                                            >
                                                <div className="p-4 pt-0 text-sm text-muted-foreground border-t border-border mt-3 pt-3">
                                                    {faq.answer}
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="prose dark:prose-invert max-w-none text-center md:text-right space-y-6" dir="rtl">
                            <h2 className="text-3xl md:text-4xl font-bold font-reem-kufi mb-6 text-foreground">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 pt-8 border-t border-border">
                            <div>
                                <h3 className="text-xl font-bold mb-3 font-playfair text-foreground">
                            ...
                            <div dir="rtl" className="text-right">
                                <h3 className="text-xl font-bold mb-3 font-reem-kufi text-foreground">
                                    أهم مسارات النقل
                                </h3>
