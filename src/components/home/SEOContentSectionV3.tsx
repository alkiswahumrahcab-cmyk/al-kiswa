                ...
                <FadeIn>
                    <div className="max-w-4xl mx-auto space-y-10">
                        ...
                        <div className="prose dark:prose-invert max-w-none text-center md:text-left space-y-8">
                            {/* Introduction */}
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold font-playfair mb-6 text-ink text-center md:text-left">
                            ...
                            <div>
                                ...
                                <div className="text-lg text-ink-muted leading-relaxed mb-4">
                                ...
                                <ul className="list-disc list-inside text-ink-muted space-y-2 ml-4 mb-4">
                                    <li>
                                        <strong>GMC Yukon / Chevrolet Tahoe:</strong> The epitome of luxury and power. Perfect for families of up to 7 passengers looking for a VIP experience. Book your <Link href="/fleet/gmc-yukon-at4" className="text-ink hover:text-gold transition-colors">GMC Yukon XL</Link> for maximum luggage space and comfort.
                                    </li>
                                    <li>
                            ...
                            <div>
                                ...
                                <p className="text-lg text-ink-muted leading-relaxed mb-4">
                                    No Umrah trip is complete without visiting the historical sites that bear witness to the history of Islam. We offer comprehensive <strong><Link href="/services/ziarah-makkah" className="text-gold hover:text-ink transition-colors underline decoration-gold/30 underline-offset-4">Ziarah services in Makkah</Link></strong>, taking you to sacred landmarks such as Jabal Al-Noor (Cave of Hira), Jannat al-Mualla, and the sites of Hajj (Mina, Arafat, Muzdalifah).
                                </p>
                                <p className="text-lg text-ink-muted leading-relaxed mb-4">
                                    Similarly, our <strong><Link href="/services/ziarah-madinah" className="text-gold hover:text-ink transition-colors underline decoration-gold/30 underline-offset-4">Madinah Ziarah packages</Link></strong> cover Masjid Quba, Mount Uhud, Masjid Qiblatayn, and the Seven Mosques. Our knowledgeable drivers often share local insights and ensure you have ample time to pray and reflect at each location. These tours are fully customizable—you can choose which sites to visit and how long to stay.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <ol className="list-decimal list-inside text-ink-muted space-y-2 ml-4 mb-4">
                                    ...
                                    <li><strong>Fixed Pricing:</strong> The price you see is the price you pay. We have a strict <Link href="/pricing" className="text-ink hover:text-gold transition-colors">no-hidden-fee policy</Link>, covering fuel, tolls, and parking.</li>
                            ...
                            <div>
                                ...
                                <div className="text-lg text-ink-muted leading-relaxed mb-6">
                            ...
                            <div className="bg-surface p-6 rounded-lg border border-border my-8">
                                ...
                                <div className="space-y-3">
                                    {seoFaqs.map((faq, index) => (
                                        <div key={index} className="border border-border rounded-lg overflow-hidden bg-bg">
                                            <button
                                                className="w-full flex items-center justify-between p-4 text-left hover:bg-surface transition-colors"
                                                onClick={() => setActiveFaq(activeFaq === index ? null : index)}
                                            >
                                                <h5 className={`font-semibold transition-colors ${activeFaq === index ? 'text-gold' : 'text-ink'}`}>
                                                    {faq.question}
                                                </h5>
                                                <ChevronDown 
                                                    size={18} 
                                                    className={`text-ink-muted transition-transform duration-300 shrink-0 ml-4 ${activeFaq === index ? 'rotate-180 text-gold' : ''}`} 
                                                />
                                            </button>
                                            <div 
                                                className={`transition-all duration-300 ease-in-out overflow-hidden ${activeFaq === index ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}
                                            >
                                                <div className="p-4 pt-0 text-sm text-ink-muted border-t border-border mt-3 pt-3">
                                                    {faq.answer}
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="prose dark:prose-invert max-w-none text-center md:text-right space-y-6" dir="rtl">
                            <h2 className="text-3xl md:text-4xl font-bold font-reem-kufi mb-6 text-ink">
                                خدمة توصيل من مطار جدة الى مكة - VIP
                            </h2>
                            <p className="text-lg text-ink-muted leading-relaxed font-amiri">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 pt-8 border-t border-border">
                            <div>
                                <h3 className="text-xl font-bold mb-3 font-playfair text-ink">
                            ...
                            <div dir="rtl" className="text-right">
                                <h3 className="text-xl font-bold mb-3 font-reem-kufi text-ink">
                                    أهم مسارات النقل
                                </h3>
                                <ul className="space-y-2 text-ink-muted font-amiri">
