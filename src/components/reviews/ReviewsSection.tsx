            ...
            <section className="py-24 relative overflow-hidden bg-background">
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="bg-card border border-border rounded-3xl p-8 h-80 animate-pulse flex flex-col">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center lg:items-end gap-5 lg:pl-12 lg:border-l border-border">
                            <div className="flex items-center gap-3 bg-card border border-border pr-4 pl-3 py-1.5 rounded-full">
