            ...
            <div className="container mx-auto px-4">
                <FadeIn>
                    <div className="text-center max-w-4xl mx-auto mb-20">
                        <h2 className="text-3xl md:text-5xl font-semibold font-display text-white mb-6">Comprehensive Umrah Transport Services</h2>
                ...
                <div className="max-w-4xl mx-auto space-y-12 mb-20">
                    ...
                    <FadeIn delay={0.2}>
                        <div className="prose dark:prose-invert max-w-none text-center md:text-right bg-neutral-900/30 p-8 rounded-3xl border border-white/5" dir="rtl">
                            <h3 className="text-2xl font-semibold font-display mb-6 text-white border-b border-white/10 pb-4 inline-block">خدمات نقل المعتمرين الموثوقة</h3>
                            <p className="text-lg text-white/70 leading-relaxed font-sans mb-6 font-light">
                                في <strong className="text-white hover:text-gold transition-colors">شركة الكسوة لنقل المعتمرين</strong>، نتشرف بأن نكون خياركم الأول والموثوق لخدمات <strong className="text-white">نقل المعتمرين في السعودية</strong>. مهمتنا هي توفير تجربة تنقل مريحة وآمنة تتيح لكم التفرغ الكامل لأداء مناسككم وعباداتكم. من لحظة وصولكم، نضمن لكم استقبالاً مميزاً عبر خدمات <strong className="text-white">التوصيل من مطار جدة</strong> ومطار المدينة المنورة، لنقلكم بكل يسر وسهولة إلى رحاب الحرمين الشريفين. سواء كنتم تؤدون العمرة أو الحج، فإن فريقنا المحترف ملتزم بتقديم أرقى مستويات <strong className="text-white">خدمة ضيوف الرحمن</strong> مع الالتزام التام بقيم الضيافة الإسلامية الأصيلة.
                            </p>
                            <p className="text-lg text-white/70 leading-relaxed font-sans font-light">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        ...
                        <FadeIn key={index} delay={0.1 * (index + 1)}>
                            <div className="bg-neutral-900 border border-white/5 rounded-3xl p-8 hover:border-gold/30 transition-colors duration-300 h-full group">
                                <h3 className="text-xl font-semibold text-white mb-4 flex items-center gap-3 font-display">
                                    ...
                                    {item.desc.split(item.linkText || "").map((part, i, arr) => (
                                        <React.Fragment key={i}>
                                            ...
                                            {i < arr.length - 1 && item.link && (
                                                <Link href={item.link} className="text-gold hover:text-white underline underline-offset-2 transition-colors font-medium">
                                                    {item.linkText}
                                                </Link>
                                            )}
                                        </React.Fragment>
