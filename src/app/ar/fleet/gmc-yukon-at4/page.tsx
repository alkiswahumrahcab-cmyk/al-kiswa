...
const generateJsonLd = (vehicleData: any) => ({
    ...
    "@graph": [
        ...
        },
        {
            ...
            "image": "https://alkiswahumrahtransport.com/images/fleet/gmc-yukon-hero-professional.webp",
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
    ...generateMetadataAlternates("/fleet/gmc-yukon-at4"),
    canonical: "https://kiswahumrahcab.com/ar/fleet/gmc-yukon-at4",
  },
    };
}
