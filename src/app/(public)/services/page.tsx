...
export default function ServicesPage() {
    ...
    const serviceFAQs = [
        ...
        },
        {
            ...
            answer: <span>Our prices are fixed and transparent. You will know the exact cost of your <Link href="/booking" className="text-gold hover:text-white transition-colors hover:underline">Umrah transport booking</Link> upfront, with no hidden fees or toll charges.</span>
        },
        {
        ...
        <main className="min-h-screen bg-charcoal relative">
            ...
            <section className="py-12 bg-deep-black border-t border-white/10 relative z-10">
                <div className="container text-center px-4">
                    <FadeIn>
                        <div className="max-w-3xl mx-auto bg-white/5 border border-gold/20 rounded-2xl p-8 backdrop-blur-sm">
