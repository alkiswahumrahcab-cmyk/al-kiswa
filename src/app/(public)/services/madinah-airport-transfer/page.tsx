                                ...
                                <div className="space-y-8">
                                    <div className="flex gap-6 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-white/60 font-light leading-relaxed">We monitor your flight status to ensure we are there when you land, adjusting for any delays automatically.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-6 group">
                                        <div className="bg-neutral-900 border border-white/10 p-4 rounded-xl h-fit text-gold group-hover:border-gold/50 transition-colors shadow-lg">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-white/60 font-light leading-relaxed">Direct transfer to your hotel lobby in the Markazia District (near Masjid Nabawi) or any other location.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-6 group">
                                        <div className="bg-neutral-900 border border-white/10 p-4 rounded-xl h-fit text-gold group-hover:border-gold/50 transition-colors shadow-lg">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-white/60 font-light leading-relaxed">Late night or early morning flight? We are always available to serve you at any hour.</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-center justify-between p-5 bg-black/40 border border-white/5 rounded-2xl hover:border-gold/30 transition-all group">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-white/50 uppercase tracking-wider">Central Hotels</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="font-bold text-gold">25 Mins</p>
                                            <p className="text-xs text-white/50">20 km</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-5 bg-black/40 border border-white/5 rounded-2xl hover:border-gold/30 transition-all group">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-white/50 uppercase tracking-wider">Direct Transfer</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="font-bold text-gold">4.5 Hours</p>
                                            <p className="text-xs text-white/50">450 km</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-5 bg-black/40 border border-white/5 rounded-2xl hover:border-gold/30 transition-all group">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-white/50 uppercase tracking-wider">Ziyarat Start</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="font-bold text-gold">30 Mins</p>
                                            <p className="text-xs text-white/50">25 km</p>
                                        </div>
                                    </div>
                                </div>

                                <p className="text-center text-xs text-white/50 mt-8 italic font-light">
                    ...
                    <div className="mt-24">
                        <FadeIn delay={0.2}>
                            <div className="max-w-3xl mx-auto text-center">
                                <h3 className="text-2xl font-semibold text-white mb-4 font-display">Hotels We Serve Near Masjid Nabawi</h3>
                                ...
                                <div key={i} className="group">
                                    <details className="group [&_summary::-webkit-details-marker]:hidden">
                                        <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-2xl bg-neutral-900 border border-white/10 p-6 text-white hover:border-gold/50 transition-colors shadow-md">
                                            ...
                                            <span className="shrink-0 rounded-full bg-white/5 p-1.5 text-white/60 sm:p-3 group-open:bg-gold/10 group-open:text-gold transition-all">
                                                <ChevronDown size={20} className="group-open:rotate-180 transition-transform duration-300" />
                                            </span>
                                        </summary>
                                        <div className="mt-4 px-6 leading-relaxed text-white/60 font-light border-l-2 border-gold/30 ml-4">
                                            {faq.answer}
                                        </div>
                                    </details>
                                </div>
