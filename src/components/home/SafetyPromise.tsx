                        ...
                        <div className="order-2 lg:order-1 flex flex-col justify-center">
                            ...
                            <FadeIn>
                                <div className="inline-flex items-start md:items-center gap-3 px-4 py-3 rounded-2xl bg-gold/10 border border-gold/20 text-gold text-sm md:text-base font-medium mb-8 max-w-xl group hover:bg-gold/15 transition-colors cursor-default">
                                    ...
                                    <span className="leading-snug text-ink" style={isAr ? { fontFamily: 'var(--font-tajawal)' } : {}}>
                            ...
                            <FadeIn delay={0.1}>
                                <h2 className="text-3xl md:text-5xl lg:text-6xl font-semibold text-ink mb-6 font-display leading-tight tracking-tight">
                                    {content.title}
                                </h2>

                                <p className="text-ink-muted text-base md:text-lg lg:text-xl mb-10 leading-relaxed max-w-xl font-light" style={isAr ? { fontFamily: 'var(--font-tajawal)' } : {}}>
                                    {content.subtitle}
                                </p>
                            </FadeIn>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                ...
                                <FadeIn delay={0.2}>
                                    <div className="bg-surface border border-border rounded-xl group flex items-center gap-4 p-4">
                                        ...
                                        <div>
                                            <h4 className="text-ink font-semibold text-lg leading-none mb-1.5 group-hover:text-gold transition-colors font-display">{content.targetTitle}</h4>
                                            <p className="text-ink-muted text-xs md:text-sm font-medium group-hover:text-ink" style={isAr ? { fontFamily: 'var(--font-tajawal)' } : {}}>{content.targetDesc}</p>
                                        </div>
                                    </div>
                                </FadeIn>
                                ...
                                <FadeIn delay={0.3}>
                                    <div className="bg-surface border border-border rounded-xl group flex items-center gap-4 p-4">
                                        ...
                                        <div>
                                            <h4 className="text-ink font-semibold text-lg leading-none mb-1.5 group-hover:text-gold transition-colors font-display">{content.commandTitle}</h4>
                                            <p className="text-ink-muted text-xs md:text-sm font-medium group-hover:text-ink" style={isAr ? { fontFamily: 'var(--font-tajawal)' } : {}}>{content.commandDesc}</p>
                                        </div>
                                    </div>
                                </FadeIn>
                            </div>
                                    ...
                                    <div className="bg-surface border border-border rounded-2xl p-6 md:p-8 relative overflow-hidden">
                                        ...
                                        <div className="flex justify-between items-center mb-8 border-b border-border pb-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-ink-muted text-xs font-mono uppercase tracking-widest">{content.statusLabel}</span>
                                            </div>
                                        ...
                                        <h4 className="text-ink font-semibold text-xl md:text-2xl mb-6 font-display">{content.sopTitle}</h4>

                                        <div className="space-y-4">
                                            {content.sopSteps.map((item, idx) => (
                                                <div key={idx} className="flex gap-4 p-3 rounded-xl hover:bg-bg transition-colors group cursor-default border border-transparent hover:border-gold/30">
                                                    <div className="flex-shrink-0 relative">
                                                        <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-bg border border-border flex items-center justify-center text-gold font-bold font-mono group-hover:border-gold group-hover:bg-gold group-hover:text-black transition-all duration-300 z-10 relative shadow-lg">
                                                            {item.step}
                                                        </div>
                                                    ...
                                                    <div>
                                                        <h5 className="text-ink font-semibold text-sm md:text-base mb-1 group-hover:text-gold transition-colors font-display">{item.title}</h5>
                                                        <p className="text-ink-muted text-xs md:text-sm leading-relaxed group-hover:text-ink transition-colors font-light" style={isAr ? { fontFamily: 'var(--font-tajawal)' } : {}}>
                                                            {item.desc}
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="mt-8 pt-6 border-t border-border text-center">
                                            <a href={isAr ? "/ar/safety" : "/safety"} className="text-xs md:text-sm text-ink-muted hover:text-ink transition-colors flex items-center justify-center gap-2 group" style={isAr ? { fontFamily: 'var(--font-tajawal)' } : {}}>
