// Config for Visa Types and Nationalities
...
// Top nationalities (Al Kiswah's top markets) - pinned to the top of the select list
...
// Lightweight ISO-2 Country List
export const COUNTRIES: { code: string; name: string; dialCode?: string; disabled?: boolean }[] = [
    {
        "code": "AF",
        "name": "Afghanistan",
        "dialCode": "+93"
