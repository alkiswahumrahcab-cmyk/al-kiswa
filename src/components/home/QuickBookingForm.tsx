        ...
        try {
            ...
            const res = await fetch('/api/bookings', {
                ...
                body: JSON.stringify({
                    ...
                    time: formData.time ? `${String(formData.time.getHours()).padStart(2, '0')}:${String(formData.time.getMinutes()).padStart(2, '0')}` : undefined,
                                        ...
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${isActive
                                                    ...
                                                    : 'bg-white/5 border-white/10 text-gray-400 hover:bg-white/10 hover:border-gold/50 hover:text-white'
                                                }
                                            `}
                                        >
                                            <route.icon size={12} className={isActive ? 'text-black' : 'text-gold'} />
                                            {route.label}
                                        </button>
                                    );
                                })}
