            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                <FadeIn>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
                        <Link href="/" className="group bg-neutral-900/50 hover:bg-neutral-900 border border-white/10 hover:border-gold/50 p-6 rounded-2xl transition-all duration-300">
