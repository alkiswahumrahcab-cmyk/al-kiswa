        ...
        <section className="py-24 bg-transparent border-t border-white/5">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
                    <FadeIn delay={0.1}>
                        <div className="flex flex-col items-center gap-4 p-8 bg-neutral-900/50 rounded-3xl border border-white/10 hover:border-gold/30 hover:bg-neutral-900 transition-all duration-300 group">
                            <div className="w-16 h-16 rounded-full bg-black border border-white/10 flex items-center justify-center text-gold group-hover:scale-110 transition-transform duration-300 shadow-inner">
                                <Shield size={32} />
                            </div>
                ...
                <FadeIn delay={0.4}>
                    <Link
                        href="/about"
                        className="inline-flex items-center gap-3 bg-white text-black px-10 py-4 rounded-full font-bold hover:bg-gold transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_hsl(var(--gold-glow) / 0.4)] hover:scale-105"
                    >
