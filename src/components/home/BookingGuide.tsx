            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <motion.h2
                        ...
                        className="text-4xl md:text-5xl font-black text-foreground mb-6 leading-tight tracking-tight"
                    >
                        {lang === 'ar' ? (
                    ...
                    <motion.p
                        ...
                        className="text-muted-foreground text-lg leading-relaxed font-medium font-light"
                    >
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                ...
                                <div className="relative mb-6">
                                    <div className="glass-panel w-24 h-24 flex items-center justify-center relative z-10 group-hover:bg-foreground/10 transition-colors">
                                    ...
                                    {/* Step Number Badge */}
                                    <div className="absolute -top-3 -right-3 w-8 h-8 bg-gold text-black rounded-lg flex items-center justify-center font-bold text-sm shadow-md z-20 border-2 border-background">
                                        {step.id}
                                    </div>
                                </div>
                                ...
                                <p className="text-muted-foreground leading-relaxed max-w-[260px] mx-auto text-base">
                                    {step.description}
                                </p>
                            </div>
                        </motion.div>
                ...
                >
                    ...
                    <p className="mt-6 text-sm font-medium text-muted-foreground flex items-center justify-center gap-2 uppercase tracking-wide">
