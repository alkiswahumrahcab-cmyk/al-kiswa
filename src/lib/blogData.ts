...
export const blogPosts: BlogPost[] = [
    {
        ...
        content: `
            <h2>?????: ???? ????? ?? ????? ?????? ??? ???? ??????</h2>
            <p>????? ?????? ?? ??? ??????? ??? ??????? ??????? ????? ??????? ?? ???? ??????. ???? ????????? ????? ???? ?? 450 ????????? ??? "???? ??????"? ???????? ???? ??????? ?. ???? ?? ???? ????? ????? ?? ???????? ???? ???? ??????? ?????? ?????? ?????? ?? <strong>??????? ???????? ???????</strong>.</p>
            <p>?? ??? ?????? ??????? ??????? ??? ?????? ??????? ?????? ?? ????????.</p>

            <h2>1. ??????? ?????: ?????? ??? 1 ????????</h2>
            <p>???? ??? ????? ???? (Private Transfer) ?????? ?????? ????? ?? 60% ?? ????????? ???? ??????? ???????:</p>
            ...
            <div style="margin: 2rem 0; text-align: center;">
                ...
                <p style="margin-top: 0.5rem; font-size: 0.85rem; color: #64748b;">????? ???? - ??? ??? ??????</p>
            </div>

            <h3>????? ???????? ???????? 2025:</h3>
            <ul>
                <li><strong>GMC Yukon (??????? 2024/2025):</strong> ??? ??????? ???????? ???? ?? 7 ???? ? 5 ????? ?????.</li>
                <li><strong>Hyundai Staria:</strong> ??? ????? ???? ???? ?????? ???? ?? 7 ???? ?? ????? ?????.</li>
                <li><strong>Toyota Camry:</strong> ???? ??????? ????? ??????? ??????? (1-3 ?????).</li>
            </ul>
            ...
            <p>????? ??????? ??? ??????? ???? ?????? ??????:</p>
            <ul>
                <li><strong>??????? ????? (GMC/Staria):</strong> ?? 600 ??? 900 ???? (??????? ?????).</li>
                <li><strong>?????? (???? ????????):</strong> ????? 170 ???? ????? ??????.</li>
                <li><strong>????? VIP:</strong> ????? 80-120 ???? ?????.</li>
            </ul>

            <div style="margin: 2rem 0; padding: 1.5rem; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 16px; text-align: center;">
                <h3 style="margin-top: 0; color: #0f172a;">?? ???? ?? ???? ????</h3>
            ...
            <p><strong>?? ??? ??? ?????? ???? ?????.</strong> <a href="/booking">???? ????? ??? ??????? ????</a> ??????? ????? ???? ??????.</p>
        `,
        category: "???? ???????",
        date: "Jan 01, 2025",
        readTime: "8 ????? ???????",
    ...
    },
    {
        ...
        content: `
            ...
            <div style="margin: 2rem 0; padding: 1.5rem; background: #fffbeb; border: 1px solid #fcd34d; border-radius: 16px; text-align: center;">
                <h3 style="margin-top: 0; color: #92400e;">?? Warning: Hidden Fees</h3>
