...
export const metadata: Metadata = {
    ...
    alternates: {
    ...generateMetadataAlternates("/ramadan-2026"),
    canonical: "https://kiswahumrahcab.com/ar/ramadan-2026",
  },
    openGraph: {
...
const ramadanPackages = [
    {
        ...
        description: <>Avoid the peak crowds with our early Ramadan saver rates. <Link href="/ar/pricing" className="text-gold hover:underline">Cheap Umrah transport rates</Link> for early Ramadan bookings.</>,
        features: [
            <span key="jed"><strong><Link href="/ar/services/jeddah-airport-transfer" className="hover:text-gold transition-colors">Jeddah Airport ➔ Makkah</Link></strong>: 200 SAR</span>,
            <span key="mak"><strong><Link href="/ar/services/makkah-madinah-taxi" className="hover:text-gold transition-colors">Makkah ➔ Madinah</Link></strong>: 450 SAR</span>,
            "Available 24/7",
    ...
    },
    {
        ...
        description: <>Priority booking for Laylatul Qadr nights and Eid. <Link href="/ar/fleet" className="text-gold hover:underline">Premium family Umrah taxi packages</Link> for Laylatul Qadr.</>,
        features: [
    ...
    },
    {
        ...
        features: [
            <span key="ziy-mak">3 Hours <strong><Link href="/ar/services/ziarah-makkah" className="hover:text-gold transition-colors">Makkah Ziyarat</Link></strong></span>,
            <span key="ziy-mad">3 Hours <strong><Link href="/ar/services/ziarah-madinah" className="hover:text-gold transition-colors">Madinah Ziyarat</Link></strong></span>,
                ...
                <div className="container mx-auto px-4">
                    <FadeIn>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-400 max-w-2xl mx-auto">Ramadan in Makkah is busy. Choose a transport partner that <Link href="/ar/booking" className="text-gold hover:underline">guarantees your arrival</Link>.</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-gold/50 transition-colors group">
                                ...
                                <p className="text-gray-400">No surge pricing when you book in advance. Bypassing the high <Link href="/ar/pricing" className="text-gold hover:underline">on-spot taxi fares</Link>.</p>
                            </div>
                        </div>
                    </FadeIn>
                </div>
